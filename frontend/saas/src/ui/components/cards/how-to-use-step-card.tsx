...
export const HowToUseStepCard = (props: CardProps) => {
    ...
    return (
        <section 
            ...
            className={cn("w-full max-w-43 sm:max-w-65 h-full max-h-40 flex flex-col items-center justify-start gap-4 p-4 border-t border-transparent transition-colors", props.className)}
        >
